      ...
      <div className="w-full max-w-xl bg-gray-900/70 backdrop-blur-md rounded-2xl shadow-2xl p-8 border border-blue-800 mx-auto">
        ...
        <div className="mb-6">
          <div className="text-lg font-semibold mb-2 flex items-center gap-2 text-cyan-300 tracking-wide">
            ...
            <svg className="w-6 h-6" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M5.121 17.804A9.004 9.004 0 0012 21a9.004 9.004 0 006.879-3.196A9.004 9.004 0 0021 12a9.004 9.004 0 00-2.585-6.317M12 3a9.004 9.004 0 00-7 9c0 2.21.8 4.225 2.121 5.804"></path></svg>
            Personal Details
          </div>
        ...
        <div className="mb-4">
          <div className="text-lg font-semibold mb-2 flex items-center gap-2 text-purple-300 tracking-wide">
            ...
            <svg className="w-6 h-6" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M3 8l7.89-3.26a2 2 0 011.64 0L21 8m-9 0v6m0 6v-6m0 0L3 8m18 0l-7.89 3.26a2 2 0 01-1.64 0L3 8"></path></svg>
            Education Details
          </div>
          <div className="grid md:grid-cols-2 gap-4">
            {[
            ...
            <div>
              <label className="block text-gray-200 font-medium mb-1">Passout Year</label>
              <input
                type="number"
                name="passoutYear"
